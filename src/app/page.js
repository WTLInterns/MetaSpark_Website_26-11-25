              ...
              <div className="relative">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-4">
                    <AnimatedCard hover delay={0.1} className="bg-gray-800 rounded-lg p-2 border border-gray-700 overflow-hidden">
                      <div className="w-full h-40 relative">
                        <img
                          src="/images/lasercutting.jpg"
                          alt="Laser Cutting"
                          className="w-full h-full object-cover rounded-lg"
                        />
                      </div>
                    </AnimatedCard>
                    <AnimatedCard hover delay={0.3} className="bg-gray-800 rounded-lg p-2 border border-gray-700 overflow-hidden">
                      <div className="w-full h-40 relative">
                        <img
                          src="/images/cncbending.jpg"
                          alt="CNC Bending"
                          className="w-full h-full object-cover rounded-lg"
                        />
                      </div>
                  ...
                  <div className="space-y-4 mt-8">
                    <AnimatedCard hover delay={0.5} className="bg-gray-800 rounded-lg p-2 border border-gray-700 overflow-hidden">
                      <div className="w-full h-40 relative">
                        <img
                    ...
                    <AnimatedCard hover delay={0.7} className="bg-gray-800 rounded-lg p-2 border border-gray-700 overflow-hidden">
                      <div className="w-full h-40 relative">
                        <img
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedSection direction="right" delay={0.6}>
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
                <div className="grid grid-cols-2 gap-6">
                  <AnimatedCard hover delay={0.8} className="bg-gradient-to-br from-slate-50 to-gray-50 rounded-lg p-6 text-center border border-gray-200">
                  ...
                  <AnimatedCard hover delay={1.0} className="bg-gradient-to-br from-slate-50 to-gray-50 rounded-lg p-6 text-center border border-gray-200">
                  ...
                  <AnimatedCard hover delay={1.2} className="bg-gradient-to-br from-slate-50 to-gray-50 rounded-lg p-6 text-center border border-gray-200">
                    <div className="text-3xl mb-2">👥</div>
                  ...
                  <AnimatedCard hover delay={1.4} className="bg-gradient-to-br from-slate-50 to-gray-50 rounded-lg p-6 text-center border border-gray-200">
                    <div className="text-3xl mb-2">🎯</div>
