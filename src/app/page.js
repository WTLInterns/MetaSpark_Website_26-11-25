        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-gradient-to-br from-gray-50 to-slate-50 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-slate-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative">
              ...
              {/* Floating badges */}
              <div className="absolute -top-4 -right-4 bg-gradient-to-br from-slate-600 to-slate-700 text-white px-4 py-2 rounded-full shadow-lg animate-pulse">
                <span className="font-bold text-sm">20+ Years</span>
              </div>
              <div className="absolute -bottom-4 -left-4 bg-gradient-to-br from-gray-600 to-gray-700 text-white px-4 py-2 rounded-full shadow-lg animate-pulse" style={{animationDelay: '1s'}}>
